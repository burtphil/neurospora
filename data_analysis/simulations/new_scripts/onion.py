...
def ztan(t,T,kappa, s=10, z0 = 0.05):
    pi = np.pi
    om = 2*pi/T
...
thermoperiod = np.linspace(0.01,0.99,10)
zeitgeber_period = np.linspace(26,31.0,10)
...
np.savez("onion_frq1_1_1_z01", warm_mesh = warm_mesh, zeit_mesh = zeit_mesh, ent = ent)
...
plt.show()
fig.savefig("onion_frq+_1_1_z01.pdf", dpi = 1200)
