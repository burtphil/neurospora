...
np.savez(save_to+"k13_bif",bif_array = bif_array, frq_tot_max_array = frq_tot_max_array, frq_tot_min_array = frq_tot_min_array, period_frq_tot_array = period_frq_tot_array)
